    ...
    return (
      <div name='contact'className="max-w-full h-full h-screen bg-slate-700 flex justify-center items-center p-4 flex flex-col sm:h-screen ">
        ...
        <div className="pb-8 flex flex-col items-center">
            ...
            <button className=" flex-col justify-center content-center items-center w-1/2 text-white border-2  border-sky-500 px-4 py-3 my-8 flex  hover:bg-gradient-to-r from-sky-500 to-blue-800  ">Hit Me Up!</button>
        </form>
      </div>
    )
  }
