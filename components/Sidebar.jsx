    ...
    const links = [
        {
            id: 1,
            label: 'LinkedIn',
            icon: <FaLinkedin size={25} width={25} height={25} />,
            href: 'https://www.linkedin.com/in/samuelegonzalez/',
            style: 'bg-blue-600 font-bold text-white',
        },
        {
            id: 2,
            label: 'Github',
            icon: <FaGithub size={25} width={25} height={25} />,
        ...
        },
        {
            id: 3,
            label: 'Email',
            icon: <HiOutlineMail size={25} width={25} height={25} margin={10} />,
        ...
        },
        {
            id: 4,
            label: 'Resume',
            icon: <BsFillPersonLinesFill size={25} width={25} height={25} />,
            ...
            <div className="hidden tablet:flex fixed flex-row left-0 top-1/2 m-auto -translate-y-1/2 pl-1 z-30">
                <ul>
                    {links.map(({ id, label, icon, href, style, download }) => (
                        <li key={id} className={`w-[150px] h-[60px] flex justify-between text-black items-center ml-[-100px] hover:ml-[-10px] duration-300 px-[12px] rounded-r-xl font-bold ${style}`}>
                            <a className="flex justify-between items-center text-left w-full text-gray-300"
